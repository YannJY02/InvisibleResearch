...
| `.cursor/**`, `.github/**`, `.gitignore`, `AGENTS.md`, `CITATION.cff`, `CONTEXT.md`, `README.md`, `research/README.md`, `docs/agents/**`, `docs/PROJECT_ISSUES.md`, `docs/SECURITY_GUIDE.md`, `docs/academic-repository-structure-research.md`, `docs/issues/**`, `docs/unused-code-policy.md`, `utils.md`, `archive.md` | Administrative or support material | Repository operation, governance, planning, citation, external-archive indexing, and developer documentation. They do not enter the data-to-claim chain. |
